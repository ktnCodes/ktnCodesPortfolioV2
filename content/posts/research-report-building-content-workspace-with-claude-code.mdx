...
date: "2026-03-25"
tags: ["meta", "agentic-engineering", "ai"]
summary: "Jake Van Clee walks through building a content creation workspace from scratch using Claude's desktop co-work mode — without VS Code. He builds a four-pillar content system with modular brand voice markdown files and makes the case for subscription-based AI workflows over API-heavy custom frameworks."
showToc: true
---

## Video
<iframe width="100%" height="400" src="https://www.youtube.com/embed/0fCQ-4J_jzk" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
**Source:** [Building a Content Workspace with Claude's Co-Work Mode](https://www.youtube.com/watch?v=0fCQ-4J_jzk) by Jake Van Clee
...
- **`voice-tone.md`** — Style, teaching instincts, directional guidance. Not prescriptive.
- **`voice-formats.md`** — How an IG script differs from a YouTube tutorial differs from an animation voiceover.
- **`voice-constraints.md`** — The "never do this" list. Injected at any time.
...
| [7:14](https://www.youtube.com/watch?v=0fCQ-4J_jzk&t=434) | Transcript ingestion begins |
| [9:11](https://www.youtube.com/watch?v=0fCQ-4J_jzk&t=551) | Hits 10K subscribers on camera |
